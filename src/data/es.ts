...
export const es = {
    ...
    projects: sharedData.projects.map((p) => ({
        ...
        ...(p.id === "cuartoinformedegobierno" && { title: "Cuarto Informe de Gobierno – Veracruz", description: "Este micrositio forma parte del portal oficial del Gobierno del Estado de Veracruz y está dedicado a presentar el Cuarto Informe de Gobierno correspondiente al periodo 2021–2022. Su objetivo es transparentar el ejercicio público, mostrar avances en políticas sociales, económicas y de infraestructura, y rendir cuentas a la ciudadanía." }),
        ...(p.id === "quintoinformedegobierno" && { title: "Quinto Informe de Gobierno – Veracruz", description: "Este micrositio forma parte del portal oficial del Gobierno del Estado de Veracruz y está dedicado a presentar el Quinto Informe de Gobierno del gobernador Cuitláhuac García Jiménez. Su propósito es informar a la ciudadanía sobre los avances, obras y acciones realizadas durante el año fiscal, con énfasis en salud, infraestructura, educación y desarrollo social." }),
        ...(p.id === "sextoinformedegobierno" && { title: "Sexto Informe de Gobierno – Veracruz", description: "forma parte del portal oficial del Gobierno del Estado de Veracruz y presenta el Sexto Informe de Resultados del gobernador Cuitláhuac García Jiménez. Su objetivo es documentar y transparentar las obras, programas y acciones realizadas durante los seis años de administración, con un enfoque visual y accesible." }),
        ...(p.id === "wtc" && { title: "World Trade Center Veracruz", description: "El World Trade Center Veracruz es un recinto de clase mundial afiliado a la World Trade Center Association (WTCA), diseñado para albergar congresos, convenciones, exposiciones y eventos corporativos. Ubicado en Boca del Río, Veracruz, este centro forma parte de una red global de más de 300 WTCs en 100 países, dedicados a promover el comercio, la inversión y el intercambio tecnológico y cultural." }),
    })),
